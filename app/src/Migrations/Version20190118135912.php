 ...
 */
final class Version20190118135912 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE dossier (id INT NOT NULL, projet_id INT DEFAULT NULL, statut VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
